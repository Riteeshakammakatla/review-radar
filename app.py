...
# fastembed uses ONNX runtime (much lighter than Torch)
# ---------------------------------------------------------------------------
print("[INFO] Loading lightweight embedding model (fastembed)...")
model = TextEmbedding(model_name="BAAI/bge-small-en-v1.5") 
# bge-small-en-v1.5 is extremely efficient and high-performing
